...
sections = {
    'docs/WRITING_RULES.md': '''## V2.7 bounded writing analysis
...
''',
    'docs/PERFORMANCE.md': '''## V2.7 bounded Writing insights analysis
...
''',
    'docs/API.md': '''## V2.7 writing-analysis bounds
...
''',
    'docs/ARCHITECTURE.md': '''## V2.7 bounded writing-result architecture
...
''',
    'docs/DEVELOPMENT.md': '''## V2.7 bounded-analysis development checks
...
''',
    'docs/TESTING.md': '''## V2.7 bounded writing-analysis coverage
