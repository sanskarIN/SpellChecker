...
void main() {
  test('benchmark reports exact unmatched curly brace totals', () {
    final summary = AnalysisBenchmarkRunner(
      scenario: AnalysisBenchmarkScenario(
        name: 'v215-curly-brace',
        repeats: 1,
    ...
    expect(sample.writingAnalyzedRuleIds, contains('unmatched-curly-brace'));
    expect(sample.writingTotalIssueCountByRule['unmatched-curly-brace'], 1);
    expect(
