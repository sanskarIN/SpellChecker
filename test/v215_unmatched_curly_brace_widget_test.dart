...
void main() {
  ...
  testWidgets('unmatched curly brace is enabled and advisory-only', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets('automatic fixes only hides unmatched curly brace findings', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(const SpellCheckerApp());
    await tester.pumpAndSettle();
  ...
  testWidgets('explicit unmatched curly brace disable persists', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(const SpellCheckerApp());
    await tester.pumpAndSettle();
    ...
    expect(stored, isNot(contains('unmatched-curly-brace')));
    expect(stored, contains('unmatched-square-bracket'));
    expect(stored, contains('unmatched-parenthesis'));
