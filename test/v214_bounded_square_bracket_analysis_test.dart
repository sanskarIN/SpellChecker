...
void main() {
  ...
  test('exactly-at-limit unmatched square bracket analysis stays complete', () {
    ...
    expect(result.totalIssueCountByRule?['unmatched-square-bracket'], 1);
  });

  test('bounded analysis reports exact omitted square bracket findings', () {
    final result = WritingAnalyzer().analyze(
      ']middle[',
      languagePack: pack,
      enabledRuleIds: const <String>{'unmatched-square-bracket'},
    ...
    expect(result.totalIssueCountByRule?['unmatched-square-bracket'], 2);
  });
