...
void main() {
  ...
  testWidgets('unmatched square bracket is enabled and advisory-only', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets('automatic fixes only hides unmatched square bracket findings', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(const SpellCheckerApp());
    await tester.pumpAndSettle();
  ...
  testWidgets('explicit unmatched square bracket disable persists', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(const SpellCheckerApp());
    await tester.pumpAndSettle();
    ...
    expect(stored, isNot(contains('unmatched-square-bracket')));
