...
void main() {
  test('benchmark reports exact unmatched parenthesis totals', () {
    final summary = AnalysisBenchmarkRunner(
      scenario: AnalysisBenchmarkScenario(
        name: 'v213-parenthesis',
        repeats: 1,
    ...
    expect(sample.writingAnalyzedRuleIds, contains('unmatched-parenthesis'));
    expect(sample.writingTotalIssueCountByRule['unmatched-parenthesis'], 1);
    expect(
